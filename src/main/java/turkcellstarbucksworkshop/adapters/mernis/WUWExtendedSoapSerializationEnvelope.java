...
class WUWSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class WUWExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(WUWDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new WUWStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static WUWDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static WUWDateTimeConverter dateTimeConverter = new WUWStandardDateTimeConverter();

    public WUWExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public WUWExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new WUWMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=WUWHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,WUWExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=WUWHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
