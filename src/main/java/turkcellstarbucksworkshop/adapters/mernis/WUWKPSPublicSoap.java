...
public class WUWKPSPublicSoap
{
    ...
    public WUWKPSPublicSoap(){}

    public WUWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public WUWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        WUWExtendedSoapSerializationEnvelope envelope= new WUWExtendedSoapSerializationEnvelope(WUWExtendedSoapSerializationEnvelope.VER11);
